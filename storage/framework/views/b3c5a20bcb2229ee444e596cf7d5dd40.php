            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-item">
                        ...
                        <h4>Modern equipment</h4>
                           <p> we have invested in state-of-the-art fitness equipment to ensure our members train with the best tools available. From advanced strength machines and free weights to modern cardio equipment and functional training setups, every piece is carefully selected to provide maximum results with safety and comfort.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-item">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-item">
                        ...
                        <p>
we know that no two fitness journeys are the same. That’s why we focus on creating customized programs designed around your goals, preferences, and lifestyle. Whether your aim is to lose weight, build muscle, improve endurance, or simply stay active, our team ensures that your plan is as unique as you are.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="ts_item">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <div class="ti_text">
                                <p>
                                    "FFT360 completely changed my lifestyle.<br>
                                    The trainers not only guided me in workouts<br>
                                    but also helped me with nutrition.<br>
                ...
                <div class="ts_item">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <div class="ti_text">
                                <p>
                                    As someone with a hectic schedule,<br>
                                    I needed a place that motivates me.<br>
                                    FFT360’s professional training plans and flexible timings<br>
                                    make it easy to stay consistent.<br>
                                    Best investment I’ve made in myself.
                                </p>
                                <h5>Ramesh K. – Business Professional</h5>
                                <div class="tt-rating">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
...
</html><?php /**PATH C:\wamp\www\FFT360-SITE\FFT360-SITE\resources\views/about-us.blade.php ENDPATH**/ ?>