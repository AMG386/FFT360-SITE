    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="canvas-menu mobile-menu">
            <ul>
                ...
                <li><a href="./class_details">Classes</a></li>
                <li><a href="./services">Services</a></li>
                <li><a href="./team">Our Team</a></li>
                <li><a href="#">Pages</a>
                    <ul class="dropdown">
                        <li><a href="./about_us">About us</a></li>
                        <li><a href="./class_timetable">Classes timetable</a></li>
                        <li><a href="./bmi_calculator">Bmi calculate</a></li>
                        <li><a href="./team">Our team</a></li>
                ...
                <div class="col-lg-6">
                    <nav class="nav-menu">
                        <ul>
                            <li><a href="./index">Home</a></li>
                            <li><a href="./about_us">About Us</a></li>
                            <li class="active"><a href="./class_details">Classes</a></li>
                            <li><a href="./services">Services</a></li>
                            <li><a href="./team">Our Team</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
